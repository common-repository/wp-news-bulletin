...
{
	$wpnb_defaults = plugin_dir_path( __FILE__ ).'lib/wpnb_defaults.php';
...
function wpnb_Settings()
{
    ...
    <div id="wpbody">
        ...
        <div id="wpnb_sidebar">
			<?php
			global $wpnb_conf;
            echo '<div class="wpnb_box">';
	echo '<a href="http://www.a1netsolutions.com/Products/WordPress-Plugins" target="_blank" class="wpnb_advert"><img src="',$wpnb_conf["VEWPATH"],'/img/wp-advert-1.png" /></a>';
	echo '</div><div class="wpnb_box">';
	echo '<a href="http://www.ahsanulkabir.com/request-quote/" target="_blank" class="wpnb_advert"><img src="',$wpnb_conf["VEWPATH"],'/img/wp-advert-2.png" /></a>';
	echo '</div>';
			?>
          </div>
        <div class="clear"></div>
